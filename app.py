...
# Resultat per roll och sektion (hårdkodat exempel – sätt riktiga summer här)
preset_scores = {
...
def generate_pdf(title: str, sections, results_map, kontaktinfo: dict) -> bytes:
    ...
    # H1 + tidsstämpel (behåll om du vill)
    ...
    # Kontaktuppgifter (en/två rader beroende på längd)
